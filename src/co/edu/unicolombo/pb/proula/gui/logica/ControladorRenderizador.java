...
import co.edu.unicolombo.pb.proula.gui.Inicio;
import co.edu.unicolombo.pb.proula.gui.Perfil;
import co.edu.unicolombo.pb.proula.gui.PerfilUsuario;
import co.edu.unicolombo.pb.proula.gui.Recipes;
import co.edu.unicolombo.pb.proula.gui.verRecetaPerfil;
...
public class ControladorRenderizador {
    ...
    public ArrayList<JPanel> renderizarRecetas(Usuario usuario, Controlador control,Recipes recipe){
        ...
        if (usuario == null) {
        throw new IllegalArgumentException("¡El ArrayList de recetas está vacío!");
    }
    ...
    public ArrayList<JPanel> renderizarRecetasPerfil(Usuario usuario, Controlador control,PerfilUsuario perfil) {
        ArrayList<Recetas> array = usuario.getRecetas();
        ArrayList<JPanel> arrayPanel = new ArrayList<>();
        ...
        boton.addActionListener(new ActionListener(){
                 ...
                 @Override
                 public void actionPerformed(ActionEvent e) {
                    verRecetaPerfil verReceta = new verRecetaPerfil();
                    verReceta.setVisible(true);
                    verReceta.setControl(control);
                    verReceta.setUsuario(usuario);
                    verReceta.setIdReceta(receta.getId());
                    verReceta.colocarDatos();
                    verReceta.setLocationRelativeTo( null);
                    verReceta.setPerfil(perfil);
                 }
        });
    ...
    public ArrayList<JPanel> renderizarRecetasPerfilPropio(Usuario usuario, Controlador control, Perfil aThis) {
          ArrayList<Recetas> array = usuario.getRecetas();
        ArrayList<JPanel> arrayPanel = new ArrayList<>();
